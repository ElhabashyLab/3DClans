...
from .clans_data_extractor import ClansDataExtractor
from .data_normalizer import DataNormalizer
from .cluster_analyzer import ClusterAnalyzer
from .clans_visualizer import ClansVisualizer
...
class ScoresEvaluator:
    ...
    def __init__(self, working_dir: str):
        ...
        self.clans_files_dir = os.path.join(working_dir, "clans_files")
